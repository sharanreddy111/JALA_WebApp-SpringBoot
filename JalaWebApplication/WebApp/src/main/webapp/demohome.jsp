						...
						<div
							...
							<div>
								...
								<ul>
									...
									<li><b>READ Operation :</b> It reads table records based
										on the input parameter.</li>
									<li><b>UPDATE Operation :</b> It executes an update
										statement on the table. It is based on the input parameter.</li>
									<li><b>DELETE Operation :</b> It deletes a specified row
										in the table. It is also based on the input parameter.</li>
								</ul>
							</div>
						</div>
						<br> <br> <br> <br> <br>
									...
									<div class="row mt-3">
										...
										<div class="col-6  px-5 ">
											...
											<p>We are helping the Job seekers to find the best
												opportunities available across India in Top MNCs. Request
												you to join the below groups.</p>
